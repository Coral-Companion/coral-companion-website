...
This project utilizes the Tailwind v4 native CSS configuration. All brand colors (such as `bg-app-bg`, `text-app-primary`, etc.) are configured directly inside the `src/input.css` file under the `@theme` directive. No `tailwind.config.js` file is required.

## 📦 Distribution Folder Structure

When deploying this project to GitHub Pages, Netlify, Vercel, or a traditional server, ensure you include:
- Your HTML files (e.g., `index.html`)
- The compiled distribution CSS file located at `dist/output.css`
